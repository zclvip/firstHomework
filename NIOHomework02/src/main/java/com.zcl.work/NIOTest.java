...
public class NIOTest {
    ...
    public static void nio_test() throws IOException{
        //通道管理器
...
//                }else if (selectionKey.isReadable()){
                    ...
                    if(buffer.hasRemaining()){
                        ...
                        System.out.println("ByteBuffer read event before compact position=" + buffer.position() + " limit=" + buffer.limit() + " capacity=" + buffer.capacity());
                        buffer.compact();
                        System.out.println("ByteBuffer read event after compact position=" + buffer.position() + " limit=" + buffer.limit() + " capacity=" + buffer.capacity());
                        buffer.flip();
                        System.out.println("ByteBuffer read event after flip position=" + buffer.position() + " limit=" + buffer.limit() + " capacity=" + buffer.capacity());
//                        buffer.clear();
...
//                }else if(selectionKey.isWritable()) {
                    ...
                    if(buffer != null){
                        ...
                        if (buffer.hasRemaining()){
                            ...
                            System.out.println("ByteBuffer write event before compact position=" + buffer.position() + " limit=" + buffer.limit() + " capacity=" + buffer.capacity());
                            buffer=buffer.compact();
                            System.out.println("ByteBuffer write event after compact position=" + buffer.position() + " limit=" + buffer.limit() + " capacity=" + buffer.capacity());
                            buffer.flip();
                            System.out.println("ByteBuffer write event after flip position=" + buffer.position() + " limit=" + buffer.limit() + " capacity=" + buffer.capacity());
                            selectionKey.attach(buffer);
                            selectionKey.interestOps(selectionKey.interestOps() | SelectionKey.OP_WRITE);
//                            socketChannel.register(selector, SelectionKey.OP_WRITE, buffer);
                        }
